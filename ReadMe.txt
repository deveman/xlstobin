========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : xlstobinconverter
========================================================================


AppWizard が生成した xlstobinconverter には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには xlstobinconverter を構成している各ファイルの概要説明が含まれています。

xlstobinconverter.dsp
...
xlstobinconverter.h
    ...
    みます） をインクルードし、また CXlstobinconverterApp アプリケーションクラスを宣
    言します。

xlstobinconverter.cpp
    このファイルは CXlstobinconverterApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。

xlstobinconverter.rc
...
res\xlstobinconverter.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル xlstobinconverter.rc によってインクルード
    されます。

res\xlstobinconverter.rc2
...
xlstobinconverterDlg.h, xlstobinconverterDlg.cpp - ダイアログ
    これらのファイルは CXlstobinconverterDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な xlstobinconverter.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) xlstobinconverter.pch 
